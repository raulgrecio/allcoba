...
describe('Provider entity', () => {
  it('rechaza coordenadas fuera de rango', () => {
    expect(() =>
      Provider.create({ lat: 91, lng: 0, ...minimalProps })
...
describe('PostgresSearchAdapter', () => {
  ...
  it('devuelve providers ordenados por distancia', async () => {
    ...
    await insertProvider(db, { lat: 40.4500, lng: -3.7200, name: 'Salón B' })  // ~4km
  ...
  it('excluye providers fuera del radio', async () => {
    await insertProvider(db, { lat: 41.6500, lng: -4.7234, name: 'Salón Valladolid' })
