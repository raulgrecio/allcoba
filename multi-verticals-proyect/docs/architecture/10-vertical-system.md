    ...
    customerTagDefinitions: [
      {
        key: 'tipo_servicio',
        type: 'enum',
        enumValues: ['corte', 'color', 'tratamiento', 'novia', 'extensiones'],
      },
      {
        key: 'frecuencia',
        type: 'enum',
        enumValues: ['única', 'esporádica', 'mensual', 'quincenal', 'semanal'],
      },
