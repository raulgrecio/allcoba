import type { Category, Listing, MarketplaceStats, Seller } from "@allcoba/ui";
...
export const LISTINGS: Listing[] = [
  {
    ...
    seller: S0,
    description:
      "BMW Serie 3 320d xDrive de 2019. 85.000 km reales, full equip, techo solar, navegación. Revisiones en BMW Madrid.",
  },
  {
    id: "l2",
  ...
  },
  {
    ...
    seller: S2,
    description:
      "Fisioterapeuta colegiado. Masaje deportivo, lesiones musculares, puntos gatillo. 60min.",
  },
  {
    id: "l7",
  ...
  {
    id: "l9",
    title: "Suzuki Swift 2021 - 28.000km",
    price: 13500,
    shippingAvailable: false,
    condition: "buen_estado",
  ...
  {
    id: "l10",
    title: "Masaje con piedras calientes 75min",
    price: 65,
    shippingAvailable: false,
    condition: "nuevo",
  ...
  {
    id: "l11",
    title: "Ford Mustang GT 2017 - 450CV",
    price: 32000,
    shippingAvailable: false,
    condition: "buen_estado",
  ...
  {
    id: "l12",
    title: "Casco Shoei GT-Air II - Talla M - Nuevo",
    price: 380,
    shippingAvailable: true,
    condition: "nuevo",
  ...
  {
    id: "l13",
    title: "Reflexología podal 60min - Centro Bienestar",
    price: 40,
    shippingAvailable: false,
    condition: "nuevo",
  ...
  {
    id: "l14",
    title: "Vespa Primavera 125 2020 - 9.000km",
    price: 3200,
    shippingAvailable: false,
    condition: "buen_estado",
