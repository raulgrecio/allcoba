        ...
        <div className="max-w-[48rem] mx-auto">
          <div className="flex items-center justify-between mb-[1.5rem]">
            <div className="flex items-center gap-[0.5rem]">
              ...
              <h1 className="text-[1.5rem] font-display font-bold text-foreground">
                Mis anuncios
              </h1>
            </div>
            <Link
          ...
          {MY_LISTINGS.length === 0 ? (
            <div className="text-center py-[5rem] text-muted-foreground border border-dashed border-border rounded-[1rem] bg-muted/20">
              ...
              <p className="text-[1.125rem] font-bold mb-[0.5rem] text-foreground">
                Aún no tienes anuncios
              </p>
              <Link
                href="/publicar"
                className={buttonVariants({ className: "rounded-full mt-[1rem]" })}
              >
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="font-bold text-[0.875rem] line-clamp-1 text-foreground">
                        {listing.title}
                      </p>
                      <p className="text-primary font-bold text-[1.125rem]">
                        {formatPrice(listing.price)}
                      </p>
                      <div className="flex items-center gap-[0.5rem] mt-[0.25rem]">
                        <span
                          className={cn(
                            "text-[0.75rem] px-[0.5rem] py-[0.125rem] rounded-full font-bold",
                            status?.className
                          )}
                        >
                          {status?.label}
                    ...
                    <div className="flex items-center gap-[0.25rem] flex-shrink-0">
                      ...
                      <button
                        ...
                        className={cn(
                          buttonVariants({ variant: "ghost", size: "icon" }),
                          "w-[2rem] h-[2rem] rounded-full text-destructive hover:text-destructive hover:bg-destructive/10"
                        )}
                      >
