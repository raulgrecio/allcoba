...
export default function HomePage() {
  return (
    <SiteLayout>
      ...
      <section className="relative bg-primary overflow-hidden">
        ...
        <div className="max-w-[80rem] mx-auto px-4 py-14 md:py-20 text-center flex flex-col items-center gap-5 relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full max-w-xs sm:max-w-sm mt-1">
            <Link
              href="/buscar"
              className={cn(buttonVariants({ variant: "secondary", size: "lg" }), "flex-1 rounded-full font-bold h-11 shadow-lg")}
            >
              Explorar
            </Link>
            <Link
              href="/publicar"
              className={cn(buttonVariants({ size: "lg" }), "flex-1 rounded-full font-bold h-11 bg-accent text-accent-foreground hover:bg-accent/90 shadow-lg")}
            >
              Publicar gratis
            </Link>
          </div>
        ...
        <div className="max-w-[80rem] mx-auto px-4">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link
              ...
              className={cn(buttonVariants({ variant: "ghost", size: "sm" }), "text-muted-foreground hover:text-primary text-sm")}
            >
      ...
      {/* ── Lo mejor, al mejor precio — grid 2-col mobile / 4-col desktop ── */}
      <section className="max-w-[80rem] mx-auto px-4 mb-10">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
