import type { Category, Listing, Seller, MarketplaceStats } from "@/types";
...
export const LISTINGS: Listing[] = [
  {
    ...
    seller: SELLERS[0],
    description: "BMW Serie 3 320d xDrive de 2019. 85.000 km reales, full equip, techo solar, navegación, asientos calefactados. Revisiones en BMW Madrid. Sin golpes ni rasguños. Precio negociable.",
  },
  {
    id: "l2",
  ...
  {
    id: "l3",
    title: "Masaje relajante 60 min — Centro SpaValencia",
    price: 45,
    shippingAvailable: false,
    condition: "nuevo",
    images: [
      "https://images.unsplash.com/photo-1600334089648-b0d3d966502e?w=600&h=600&fit=crop",
    ],
    city: "Valencia",
    vertical: "masajes",
  ...
  {
    id: "l4",
    title: "Kit frenos Brembo BMW - Nuevo",
    price: 320,
  ...
  {
    id: "l5",
    title: "Toyota Corolla 2020 Hybrid - Full equip",
    price: 18900,
    shippingAvailable: false,
    condition: "buen_estado",
    images: [
      "https://images.unsplash.com/photo-1621007947382-bb3c3994e3fb?w=600&h=600&fit=crop",
    ],
    city: "Madrid",
    vertical: "automocion",
    categorySlug: "coches",
  ...
  {
    id: "l6",
    title: "Masaje deportivo / lesiones — Fisioterapia",
    price: 55,
    shippingAvailable: false,
    condition: "nuevo",
    images: [
  ...
  },
  {
    ...
    condition: "buen_estado",
    images: [
      "https://images.unsplash.com/photo-1616455579100-2ceaa4eb2d37?w=600&h=600&fit=crop",
    ],
    city: "Bilbao",
    vertical: "automocion",
    categorySlug: "coches",
  ...
  {
    id: "l8",
    title: "Yamaha MT-07 2022 - 8.000km",
    price: 7200,
    shippingAvailable: false,
    condition: "como_nuevo",
    images: [
...
export const FEATURED_LISTINGS = LISTINGS.slice(0, 4);
export const RECENT_LISTINGS = [...LISTINGS].reverse().slice(0, 8);
export const NEAR_LISTINGS = LISTINGS.filter((l) => l.city === "Madrid" || l.city === "Barcelona");
