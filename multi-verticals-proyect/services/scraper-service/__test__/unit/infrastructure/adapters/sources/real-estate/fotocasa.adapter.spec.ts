...
describe('Unit: FotocasaAdapter (Offline)', () => {
  it('debería extraer correctamente los campos básicos usando el HTML persistido', async () => {
    const htmlPath = path.resolve(__dirname, '../../../../../../storage/raw/fotocasa_188764809.html');
    ...
    const { data } = await adapter.extract('https://www.fotocasa.es/es/comprar/vivienda/madrid-capital/188764809/d');
