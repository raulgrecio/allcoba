...
export const mapEscortAdvisor = async (
  ...
  return {
    ...
    contactOptions: [
      ...
      ...(payload.whatsapp ? (['whatsapp'] as const) : []),
    ],
    personalDetails,
    ...
    links: {},
    otherPlatforms: [],
    reviewsEnabled: payload.reviewsCount !== undefined && payload.reviewsCount > 0,
    reviewsCount: payload.reviewsCount ?? 0,
    reviewsRating: payload.reviewsRating ?? 0,
    ...
    attributes: {
      ...
      city: payload.params.city,
      priceText: payload.params.priceText,
      meetingRaw: payload.params.meetingRaw,
      bodyType: payload.params.bodyType,
      eyeColor: payload.params.eyeColor,
